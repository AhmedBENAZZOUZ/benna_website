              ...
              <div class="row gy-4">
                <div class="col-xl-4" data-aos="fade-up" data-aos-delay="100">
                  <div class="icon-box d-flex flex-column justify-content-center align-items-center"
                    ...
                    <div class="why-box">
                      <a href="traditionnal.php?type=Traditionnal Dish" class="more-btn">discover </a>
                    </div>
                  </div>
                </div><!-- End Icon Box -->
                <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box d-flex flex-column justify-content-center align-items-center"
                    ...
                    <div class="why-box">
                      <a href="salty.php?type=Salty Dish" class="more-btn">discover </a>
                    </div>
                  </div>
                </div><!-- End Icon Box -->
                <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                  <div class="icon-box d-flex flex-column justify-content-center align-items-center"
                    ...
                    <div class="why-box">
                      <a href="sweet.php?type=Sweet Dish" class="more-btn">discover </a>
                    </div>
                  </div>
                </div><!-- End Icon Box -->
              </div>
                ...
                <div class="row gy-4">
                  ...
                  <div class="col-lg-6 col-md-6">
                    <select class="form-select" name="difficulte">
                      <option value="non_sense">Choose Difficulty</option>
                ...
                <div class="row justify-content-center">
                  <div class="my-3">
                    <select class="form-select" name="type_plat">
                      <option value="non_sense">Type of Dish </option>
                      <option value="Sweet Dish">Sweet Dish </option>
                      <option value="Salty Dish">Salty Dish </option>
                      <option value="Traditionnal Dish">Traditionnal Dish</option>
                      <option value="Diabetics Dish">Diabetics Dish</option>
                      <option value="Vegetariens Dish">Vegetariens Dish</option>
                    </select>
                    <br />
                    <div class="row gy-4">
